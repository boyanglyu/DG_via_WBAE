...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="/cluster/tufts/aeronlab/blyu01/DomainBed_WBAE/DomainBed_WBAE_Run_1/domainbed/data/path")
    parser.add_argument("--dataset", type=str, default="PACS")
    parser.add_argument("--algorithm", type=str, default="WBAE")
    parser.add_argument(
        "--trial_seed",
        type=int,
        default=0,
    ...
    parser.add_argument("--wbae_alpha", type=float)
    parser.add_argument("--wbae_beta", type=float)
    ##########
    ...
    hparams["wbae_alpha"] = args.wbae_alpha
    hparams["wbae_beta"] = args.wbae_beta
    #######################
