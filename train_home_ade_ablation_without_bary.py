    ...
    for alpha in alpha_list:
        for beta in beta_list:
            for test_file in test_file_list:
                ...
                if not os.path.exists('office_home_new_val/without_bary/home_checkpoint_AED' + str(repeat)):
                    os.makedirs('office_home_new_val/without_bary/home_checkpoint_AED'+ str(repeat))
                if not os.path.exists('office_home_new_val/without_bary/history_home_AED'+ str(repeat)):
                    os.makedirs('office_home_new_val/without_bary/history_home_AED'+ str(repeat))

                check_folder = 'office_home_new_val/without_bary/home_checkpoint_AED'+ str(repeat) + '/'
                history_folder = 'office_home_new_val/without_bary/history_home_AED'+ str(repeat) + '/'
