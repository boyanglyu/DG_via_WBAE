    ...
    for alpha in alpha_list:
        for beta in beta_list:
            for test_file in test_file_list:
                ...
                if not os.path.exists('office_home_new_val/home_checkpoint_MI'+ str(repeat)):
                    os.makedirs('office_home_new_val/home_checkpoint_MI'+ str(repeat))
                if not os.path.exists('office_home_new_val/history_home_MI'+ str(repeat)):
                    os.makedirs('office_home_new_val/history_home_MI'+ str(repeat))
                # Classifier and AE
                # file_path = 'office_home/history_home_AE/'
                check_folder = 'office_home_new_val/home_checkpoint_MI'+ str(repeat) + '/'
                history_folder = 'office_home_new_val/history_home_MI'+ str(repeat) + '/'
