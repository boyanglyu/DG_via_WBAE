    ...
    for alpha in alpha_list:
        for beta in beta_list:
            for test_file in test_file_list:
                ...
                if not os.path.exists('vlcs_new_val/without_recon/vlcs_checkpoint_AED' + str(repeat)):
                    os.makedirs('vlcs_new_val/without_recon/vlcs_checkpoint_AED'+ str(repeat))
                if not os.path.exists('vlcs_new_val/without_recon/history_vlcs_AED'+ str(repeat)):
                    os.makedirs('vlcs_new_val/without_recon/history_vlcs_AED'+ str(repeat))

                check_folder = 'vlcs_new_val/without_recon/vlcs_checkpoint_AED'+ str(repeat) + '/'
                history_folder = 'vlcs_new_val/without_recon/history_vlcs_AED'+ str(repeat) + '/'
