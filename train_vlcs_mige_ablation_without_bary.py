    ...
    for alpha in alpha_list:
        for beta in beta_list:
            for test_file in test_file_list:
                ...
                if not os.path.exists('vlcs_new_val/no_bary_MI/vlcs_checkpoint_MI'+ str(repeat)):
                    os.makedirs('vlcs_new_val/no_bary_MI/vlcs_checkpoint_MI'+ str(repeat))
                if not os.path.exists('vlcs_new_val/no_bary_MI/history_vlcs_MI'+ str(repeat)):
                    os.makedirs('vlcs_new_val/no_bary_MI/history_vlcs_MI'+ str(repeat))
                # Classifier and AE
                # file_path = 'office_vlcs/history_vlcs_AE/'
                check_folder = 'vlcs_new_val/no_bary_MI/vlcs_checkpoint_MI'+ str(repeat) + '/'
                history_folder = 'vlcs_new_val/no_bary_MI/history_vlcs_MI'+ str(repeat) + '/'
